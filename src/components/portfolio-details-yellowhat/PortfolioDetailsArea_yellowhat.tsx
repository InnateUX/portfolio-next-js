...
import portfolio_details_img_1 from "@/assets/img/portfolio/yellowhat/Yellowhat_mock1.png";
import portfolio_details_img_2 from "@/assets/img/portfolio/yellowhat/Yellowhat_mock2.png";
import portfolio_details_img_3 from "@/assets/img/portfolio/yellowhat/yellowhat_mock3.jpg";
...
const { title, features, counter_data } = portfolio_detaisl_content;
...
<div className="service-details__sm-thumb-wrap mb-60 text-center">
  <div className="container">
              ...
              <div className="row align-items-center">
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content text-center text-md-start">
                    <a href="/portfolio-details-avristories">
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content next text-center text-md-end">
                    <a href="/portfolio-details-stylisticme"><span>Next</span><i className="fa-regular fa-arrow-right"></i></a>
                    <h4>
                      Stylistic Me
                    </h4>
                  </div>
