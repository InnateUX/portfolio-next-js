...
import portfolio_details_img_1 from "@/assets/img/portfolio/stylisticme/Stylisticme_mock1.png";
import portfolio_details_img_2 from "@/assets/img/portfolio/stylisticme/StylisticMe_mock2.png";
import portfolio_details_img_3 from "@/assets/img/portfolio/stylisticme/Stylisticme_mock3.jpg";
              ...
              <div className="row align-items-center">
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content text-center text-md-start">
                    <a href="/portfolio-details-yellowhat">
