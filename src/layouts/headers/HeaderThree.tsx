...
import lightLogo from '@/assets/img/logo/logo_white.png';
import darkLogo from '@/assets/img/logo/logo_dark.png';
            ...
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  <Link className="logo-white" href="/home-3"><Image src={lightLogo} alt="image-here" /></Link>
                  <Link className="logo-black" href="/home-3"><Image src={darkLogo} alt="image-here" /></Link>
                </div>
              </div>
