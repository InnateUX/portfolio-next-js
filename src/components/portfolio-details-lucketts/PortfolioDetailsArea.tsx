...
const portfolio_detaisl_content: DataType = {
  title: "Through this work, I ensure our solutions are not only visually engaging but also strategically aligned to meet the evolving needs of real estate professionals. MLS brings together nine MLSs in the Mid-Atlantic, covering parts of six states and Washington, D.C., to support over 85,000 real estate professionals with approximately 250,000 annual transactions totaling over $70 billion. This collaborative MLS serves as a comprehensive resource, offering tools and data to empower real estate professionals across the region.",
  features: [
    "Through this work, I ensure our solutions are not only visually engaging but also strategically",
