...
import portfolio_details_img_1 from "@/assets/img/portfolio/bright_featured_image.png";
import portfolio_details_img_2 from "@/assets/img/portfolio/Bright_Example1.png";
...
const portfolio_detaisl_content: DataType = {
  title: "Technology that drives some of the best Platforms Out there is nothing without great planning",
  features: [
              ...
              <div className="row align-items-center">
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content next text-center text-md-end">
                    <a href="/portfolio-details-lucketts"><span>Next</span><i className="fa-regular fa-arrow-right"></i></a>
                    <h4>
                      Lucketts
                    </h4>
                  </div>
