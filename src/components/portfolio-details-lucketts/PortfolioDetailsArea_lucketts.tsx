...
import portfolio_details_img_1 from "@/assets/img/portfolio/lucketts/lucketts_featured.png";
import portfolio_details_img_2 from "@/assets/img/portfolio/lucketts/lucketts_mock1.png";
import portfolio_details_img_3 from "@/assets/img/portfolio/lucketts/lucketts_mock2.png";
...
{/* Removed the Overview and Results sections */}
              ...
              <div className="row align-items-center">
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content text-center text-md-start">
                    <a href="/portfolio-details-bright">
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content next text-center text-md-end">
                    <a href="/portfolio-details-avristories"><span>Next</span><i className="fa-regular fa-arrow-right"></i></a>
                    <h4>
                      Avri Stories
                    </h4>
                </div>
