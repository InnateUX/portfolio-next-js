...
import portfolio_details_img_1 from "@/assets/img/portfolio/avristories/avristories_mock1.png";
import portfolio_details_img_2 from "@/assets/img/portfolio/avristories/avristories_mock2.png";
import portfolio_details_img_3 from "@/assets/img/portfolio/avristories/avristories_mock3.png";
...
import portfolio_img_4 from "@/assets/img/portfolio/Homepage - Hifi.jpg";

const portfolio_detaisl_content = {
  title: "that drives some of the best Platforms Out there is nothing without great planning",
  features: [
        ...
        <div className="container">
          <div className="row">
            ...
            <div style={{ textAlign: 'center' }}>
              <br />
              <br />
              <h4 className="porfolio-details__overview-title mb-40">Check out examples of the work</h4>
            </div>

            <div className="service-details__sm-thumb-wrap mb-60" style={{ display: 'flex', justifyContent: 'center' }}>
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-xl-10">
                    <div className="service-details__sm-thumb">
                      <Image src={portfolio_details_img_2} style={{ height: 'auto' }} alt="image-here" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="service-details__sm-thumb-wrap mb-60" style={{ display: 'flex', justifyContent: 'center' }}>
              <div className="container">
                <div className="row justify-content-center">
                  <div className="col-xl-10">
                    <div className="service-details__sm-thumb">
                      <Image src={portfolio_details_img_3} style={{ height: 'auto' }} alt="image-here" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Removed "Overview" and "Results" sections */}
              ...
              <div className="row align-items-center">
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content text-center text-md-start">
                    <a href="/portfolio-details-lucketts">
                ...
                <div className="col-xl-4 col-lg-4 col-md-4 col-12">
                  <div className="porfolio-details__navigation-content next text-center text-md-end">
                    <a href="/portfolio-details-yellowhat"><span>Next</span><i className="fa-regular fa-arrow-right"></i></a>
                    <h4>
                      Yellow Hat
                    </h4>
                  </div>
